...
- [cgroup과 namespace는 container를 process처럼 보이게 만드는 장치다](#cgroup과-namespace는-container를-process처럼-보이게-만드는-장치다)
...
- [현실 시나리오: container memory limit 안에서 Spark executor가 죽는다](#현실-시나리오-container-memory-limit-안에서-spark-executor가-죽는다)
