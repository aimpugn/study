...
- 확인 명령 후보: `dig +trace www.example.com`, `dig www.example.com A`, `curl -v --http2 https://example.com`, `openssl s_client -connect example.com:443 -servername example.com -alpn h2`, `tcpdump -nn host <ip> and port 443`, `ss -antp`, `lsof -i :443`, Nginx access/error log, Tomcat access log, Spring actuator metrics, DB slow query log
