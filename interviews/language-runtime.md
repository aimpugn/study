...
- [언어와 런타임](#언어와-런타임)
    ...
    - [JVM 실행 모델](#jvm-실행-모델)
        - [1. Java 관련 질문](#1-java-관련-질문)
            - [원문: 1. Java 관련 질문](#원문-1-java-관련-질문)
                - [1. Java 관련 질문](#1-java-관련-질문-1)
        ...
        - [JVM, PHP runtime, Go runtime](#jvm-php-runtime-go-runtime)
            - [원문: JVM, PHP runtime, Go runtime](#원문-jvm-php-runtime-go-runtime)
                - [JVM, PHP runtime, Go runtime](#jvm-php-runtime-go-runtime-1)
    - [Kotlin 언어 기능](#kotlin-언어-기능)
        - [infix, inline, noinline, crossinline](#infix-inline-noinline-crossinline)
            - [원문: infix, inline, noinline, crossinline](#원문-infix-inline-noinline-crossinline)
                - [infix, inline, noinline, crossinline](#infix-inline-noinline-crossinline-1)
                    - [Infix](#infix)
                    - [Inline](#inline)
                    - [Noinline](#noinline)
                    - [Crossinline](#crossinline)
        - [kotlin의 `when` 표현식에서의 exhaustiveness 체크](#kotlin의-when-표현식에서의-exhaustiveness-체크)
            - [원문: kotlin의 `when` 표현식에서의 exhaustiveness 체크](#원문-kotlin의-when-표현식에서의-exhaustiveness-체크)
                - [kotlin의 `when` 표현식에서의 exhaustiveness 체크](#kotlin의-when-표현식에서의-exhaustiveness-체크-1)
    - [언어 런타임 비교](#언어-런타임-비교)
        - [Apache + mod_php와 Nginx + php-fpm의 차이](#apache--mod_php와-nginx--php-fpm의-차이)
            - [원문: Apache + mod_php와 Nginx + php-fpm의 차이](#원문-apache--mod_php와-nginx--php-fpm의-차이)
                - [Apache + mod_php와 Nginx + php-fpm의 차이](#apache--mod_php와-nginx--php-fpm의-차이-1)
        - [Golang의 Concurrent Mark and Sweep(CMS)](#golang의-concurrent-mark-and-sweepcms)
            - [원문: Golang의 Concurrent Mark and Sweep(CMS)](#원문-golang의-concurrent-mark-and-sweepcms)
                - [Golang의 Concurrent Mark and Sweep(CMS)](#golang의-concurrent-mark-and-sweepcms-1)
        - [VM, GC, 그리고 런타임](#vm-gc-그리고-런타임)
            - [원문: VM, GC, 그리고 런타임](#원문-vm-gc-그리고-런타임)
                - [VM, GC, 그리고 런타임](#vm-gc-그리고-런타임-1)
    - [함수형 프로그래밍 모델](#함수형-프로그래밍-모델)
        - [함수형](#함수형)
            - [원문: 함수형](#원문-함수형)
                - [함수형](#함수형-1)
...
<!-- curriculum-chunk: sha256=9c428c3213103c7d65c1545975794a9d752dc7f0745326de57513d415813574d major=language-runtime mid=Class loading과 실행 준비 sub=부모 위임 모델 sources=source/interview_questions.md:10148-10266, source/interviews.md:10096-10214 -->

> Source: `source/interview_questions.md:10148-10266`
> Classification reason: class loading
> Duplicate source aliases: `source/interview_questions.md:10148-10266, source/interviews.md:10096-10214`
...
<!-- curriculum-chunk: sha256=bd3bb9b7fec3aa36236c525e46c19775fa6a88eec9d187c0697824747c9fb0f3 major=language-runtime mid=JVM 실행 모델 sub=1. Java 관련 질문 sources=source/interview_questions3.md:92-129 -->

> Source: `source/interview_questions3.md:92-129`
...
<!-- curriculum-chunk: sha256=9bc80b8dd4af126ddfb4d1a276d414438a416b2f930309548700c6bb286cdb95 major=language-runtime mid=JVM 실행 모델 sub=JVM, PHP runtime, Go runtime sources=source/interview_questions.md:5545-5614, source/interviews.md:5545-5614 -->

> Source: `source/interview_questions.md:5545-5614`
> Classification reason: jvm execution
> Duplicate source aliases: `source/interview_questions.md:5545-5614, source/interviews.md:5545-5614`
...
<!-- curriculum-chunk: sha256=d42f5b06f742e1addd1018ce374d6395a1bc25c2d300634df1feec047bf09026 major=language-runtime mid=Kotlin 언어 기능 sub=infix, inline, noinline, crossinline sources=source/interview_questions2.md:1499-1629, source/interviews2.md:1499-1629 -->

> Source: `source/interview_questions2.md:1499-1629`
> Classification reason: kotlin language
> Duplicate source aliases: `source/interview_questions2.md:1499-1629, source/interviews2.md:1499-1629`
...
<!-- curriculum-chunk: sha256=b6ad5f1248b2d1f9a43415eabf943d73258e8d96b61aad6169a0265e44c0142b major=language-runtime mid=Kotlin 언어 기능 sub=kotlin의 `when` 표현식에서의 exhaustiveness 체크 sources=source/interview_questions.md:3562-3673, source/interviews.md:3562-3673 -->

> Source: `source/interview_questions.md:3562-3673`
> Classification reason: kotlin language
> Duplicate source aliases: `source/interview_questions.md:3562-3673, source/interviews.md:3562-3673`
...
<!-- curriculum-chunk: sha256=557e3f66a06efdd93b06acb1ad66f2703591d46278fbcb12a44072660501fe1c major=language-runtime mid=언어 런타임 비교 sub=Apache + mod_php와 Nginx + php-fpm의 차이 sources=source/interview_questions.md:5420-5544, source/interviews.md:5420-5544 -->

> Source: `source/interview_questions.md:5420-5544`
> Classification reason: runtime comparison
> Duplicate source aliases: `source/interview_questions.md:5420-5544, source/interviews.md:5420-5544`
...
<!-- curriculum-chunk: sha256=46cffff50deb329343dffa9aa58948ebf7a14dc32d62840f7b10c7cb95456a0e major=language-runtime mid=언어 런타임 비교 sub=Golang의 Concurrent Mark and Sweep(CMS) sources=source/interview_questions.md:5320-5419, source/interviews.md:5320-5419 -->

> Source: `source/interview_questions.md:5320-5419`
> Classification reason: runtime comparison
> Duplicate source aliases: `source/interview_questions.md:5320-5419, source/interviews.md:5320-5419`
...
<!-- curriculum-chunk: sha256=50235565c4d721960fb1b2483d267199799ea865bdd8edc38ee71bd4d259142d major=language-runtime mid=언어 런타임 비교 sub=VM, GC, 그리고 런타임 sources=source/interview_questions.md:5287-5319, source/interviews.md:5287-5319 -->

> Source: `source/interview_questions.md:5287-5319`
> Classification reason: runtime comparison
> Duplicate source aliases: `source/interview_questions.md:5287-5319, source/interviews.md:5287-5319`
...
<!-- curriculum-chunk: sha256=7c5b45abb7d6106d2c28451a32820c77390e1b67a1411b1028aee41bbbd90e87 major=language-runtime mid=함수형 프로그래밍 모델 sub=함수형 sources=source/interview_questions2.md:1743-2120, source/interviews2.md:1743-2120 -->

> Source: `source/interview_questions2.md:1743-2120`
> Classification reason: functional programming
> Duplicate source aliases: `source/interview_questions2.md:1743-2120, source/interviews2.md:1743-2120`
