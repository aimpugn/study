...
- [분산 시스템과 아키텍처](#분산-시스템과-아키텍처)
    ...
    - [MSA와 결제 시스템 설계](#msa와-결제-시스템-설계)
        - [결제 MSA에서 결제 PG사 기능 구현](#결제-msa에서-결제-pg사-기능-구현)
            - [원문: 결제 MSA에서 결제 PG사 기능 구현](#원문-결제-msa에서-결제-pg사-기능-구현)
                - [결제 MSA에서 결제 PG사 기능 구현](#결제-msa에서-결제-pg사-기능-구현-1)
    - [가용성, 토폴로지, 확장성](#가용성-토폴로지-확장성)
        - [5. 종합 아키텍처/적용 질문](#5-종합-아키텍처적용-질문)
            - [원문: 5. 종합 아키텍처/적용 질문](#원문-5-종합-아키텍처적용-질문)
                - [5. 종합 아키텍처/적용 질문](#5-종합-아키텍처적용-질문-1)
        ...
        - [Distributed Systems에서 고가용성이란?](#distributed-systems에서-고가용성이란)
            - [원문: Distributed Systems에서 고가용성이란?](#원문-distributed-systems에서-고가용성이란)
                - [Distributed Systems에서 고가용성이란?](#distributed-systems에서-고가용성이란-1)
        - [토폴로지](#토폴로지)
            - [원문: 토폴로지](#원문-토폴로지)
                - [토폴로지](#토폴로지-1)
    - [일관성과 분산 트랜잭션](#일관성과-분산-트랜잭션)
        - [eventual consistency](#eventual-consistency)
            - [원문: eventual consistency](#원문-eventual-consistency)
...
분산 시스템과 아키텍처 문서는 박스 그림을 예쁘게 만드는 문서가 아닙니다. 요청, 상태 변경, 실패 관측이 여러 노드로 흩어졌을 때 누가 조정자(coordinator)가 되고, 어떤 replica가 어떤 순서의 변경을 봤으며, 실패 후 어디서 다시 시작할 수 있는지를 설명해야 합니다.
